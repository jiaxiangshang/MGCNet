...
from baselib_python.Common.Notify import Notify
...
class Network(object):
    ...
    @layer
    def avg_pool3d(self, input_tensor, pool_size, strides, name, data_format, padding=DEFAULT_PADDING):
        """"Average pooling."""
        return tf.layers.average_pooling3d(input_tensor,
                                           pool_size=pool_size,
                                           strides=strides,
                                           padding=padding,
