...
def resnet_v1_50_slgView(inputs,
                 num_classes=None,
                 is_training=True,
                 global_pool=True,
                 output_stride=None,
  ...
  blocks = [
      resnet_v1_block('block1', base_depth=64, num_units=2, stride=1),
  ]
  return resnet_v1(
      inputs,
      blocks,
...
def resnet_v1_50_mulView(inputs,
                 num_classes=None,
                 is_training=True,
                 global_pool=True,
                 output_stride=None,
  ...
  """ResNet-50 model of [1]. See resnet_v1() for arg and return description."""
  blocks = [
      resnet_v1_block('block1_final', base_depth=64, num_units=1, stride=2),
